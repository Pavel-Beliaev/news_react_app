...
export const CustomButton: FC<PropsType> = ({
  ...
  const handlerStyle = (skin: PropsType['skin']): string => {
    switch (skin) {
      case 'form':
        return 'my-button w-[30px] h-[30px] rounded bg-[#567b95] hover:bg-[#326891] text-white';
      case 'dots':
        return 'opacity-0 group-hover:opacity-100';
      case 'share':
        return 'my-button rounded-full border border-[#C7C7C7] hover:bg-yellow-100';
      case 'error':
        return 'p-[8px_25px] font-semibold bg-[#567b95] hover:bg-[#326891] text-white rounded flex items-center justify-between gap-x-3';
      default:
